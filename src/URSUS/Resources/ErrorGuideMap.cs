...
namespace URSUS.Resources
{
    ...
    public static class ErrorGuideMap
    {
        ...
        /// <summary>Version-controlled support documentation in this repository.</summary>
        private const string DocsBase =
            "https://github.com/TeacherChae/URSUS/blob/main/docs";
        private const string ApiKeysGuide = DocsBase + "/api-keys.md";
        private const string InstallationGuide = DocsBase + "/installation.md";
        private const string TroubleshootingGuide = DocsBase + "/troubleshooting.md";
        private const string GettingStartedGuide = DocsBase + "/getting-started.md";
        private const string CsvGuide = DocsBase + "/csv-export.md";

        /// <summary>해당 에러 코드에 가이드가 없을 때 반환할 기본 URL</summary>
        private const string DefaultGuideUrl = TroubleshootingGuide;
        ...
        private static readonly Dictionary<string, GuideEntry> _entries = new()
        {
            ...
            [ErrorCodes.VWorldServerError] = new(
                TroubleshootingGuide + "#vworld-server",
                "VWorld 서버 점검 여부를 확인합니다. 잠시 후 재시도하세요."),

            [ErrorCodes.SeoulServerError] = new(
                TroubleshootingGuide + "#seoul-server",
            ...
            [ErrorCodes.FileAccessDenied] = new(
                TroubleshootingGuide + "#file-permission",
                "파일/폴더 쓰기 권한을 확인합니다. 관리자 권한이 필요할 수 있습니다."),

            [ErrorCodes.FileSaveFailed] = new(
                TroubleshootingGuide + "#file-save",
        ...
        ///   가이드: https://github.com/TeacherChae/URSUS/blob/main/docs/api-keys.md#vworld
        /// </summary>
